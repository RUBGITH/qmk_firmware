...
[L0] = LAYOUT_2_shifts(
	KC_GESC, KC_1, KC_2, KC_3, KC_4, LT(L1, KC_5), KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, XXXX, KC_BSPC,
	...
	KC_LCTL, KC_LGUI, KC_LALT, KC_BSPC, MO(L1), KC_SPC, KC_RALT, MO(L2), KC_LEFT, KC_DOWN, KC_RIGHT),
